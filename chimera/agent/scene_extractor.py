...
from chimera.core import Scene
...
def create_scene_extractor_agent():
    ...
    output_parser = JsonOutputParser(pydantic_object=Scene)
    prompt = hub.pull("kky/extract_scene").partial(format_instruction=output_parser.get_format_instructions())
